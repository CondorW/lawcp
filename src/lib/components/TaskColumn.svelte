...
<div class="flex flex-col h-full min-h-0 w-full pt-4" role="list" ondragover={onDragOver} ondrop={onDrop}>
	...
	<div class="flex-1 min-h-0 overflow-y-auto overflow-x-hidden custom-scrollbar">
		<div class="grid grid-cols-[repeat(auto-fill,minmax(185px,1fr))] items-start gap-3 px-3 pt-1 pb-4 w-full">
			...
			<div 
				...
				class="col-span-full w-full min-h-[4rem] border-2 border-transparent border-dashed rounded-xl transition-colors opacity-50 shrink-0 mt-2" 
