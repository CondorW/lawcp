...
<div class="rounded-xl border border-amber-200/60 bg-[#FFFDF5] dark:bg-slate-900 dark:border-amber-900/30 p-1 shadow-sm transition-all focus-within:ring-2 focus-within:ring-amber-500/20 focus-within:border-amber-400">
